...
class pcMos18FingerGenerator:
    ...
    def _MOS18Finger(self,layout, cell, well, w, l, sab, gate_contact, gate_contact_num, finger_num, sdCovmCON):
      ...
      widStack = max(self.w*sdCovmCON/100.0, widStack_licon, widStack_mcon)
