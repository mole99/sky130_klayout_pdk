...
# Taher Kourany, 28.11.22 -- Initial version of nmos5 pcell generator (w,l,sab,gate_contact,gate_contact_num,finger_num,grCovmCON,sdCovmCON)
...
class pcnvtNmos5Generator(pya.PCellDeclarationHelper):

    """
    Description: 5.0v Native Nmos Pcell for Skywaters 130nm
    """
    ...
    def __init__(self):
        ...
        super(pcnvtNmos5Generator, self).__init__()
        ...
        self.param("des_param", self.TypeString, "Description", default= "SkyWater 130nm Native NMOS5v0 Pcell", readonly = True)
    ...
    def display_text_impl(self):
        ...
        return "pcnvtNmos5 (w=%.4gum,l=%.4gum)" % (self.w,self.l)
    ...
    def coerce_parameters_impl(self):
      ...
      # min length for 5.0v native nmos = 0.9um
      l_min = 0.9 
    ...
    def _nvtmos5FingerTrans(self, cell, well, w, l, sab, gate_contact, gate_contact_num, finger_num, sdCovmCON):

      instpcMos5Finger = pcMos18FingerGenerator()
      stdmos5 = instpcMos5Finger._MOS18Finger(self.layout,self.cell,well,w, l, sab, gate_contact, gate_contact_num, finger_num, sdCovmCON)

    def _nvtn5gring(self, cell, w, l, sab, gate_contact_num, finger_num, typ, grCovmCON):
    ...
    def _nvtNmos5(self, w, l, sab, gate_contact, gate_contact_num, finger_num, grCovmCON, sdCovmCON):

      # diff implant input to _nvtmos5FingerTrans
      self.wellmos5 = "N+S/D"
      
      # instantiate guard ring
      self._nvtn5gring(self.cell, w, l, sab, gate_contact_num, finger_num,"05v0_nvt", grCovmCON)
      
      self._nvtmos5FingerTrans(self.cell, self.wellmos5, w, l, sab, gate_contact, gate_contact_num, finger_num, sdCovmCON)

    def produce_impl(self):

      # call GRing sub fucntion (__pcnvtNmos5)
      nvtNmos5 = self._nvtNmos5(self.w, self.l,self.sab,self.gate_contact,self.gate_contact_num,self.finger_num,self.grCovmCON,self.sdCovmCON)
