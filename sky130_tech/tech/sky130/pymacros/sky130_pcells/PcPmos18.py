...
class pcPmos18Generator(pya.PCellDeclarationHelper):
    ...
    def _stdmos18FingerTrans(self, cell, well, w, l, sab, gate_contact, gate_contact_num, finger_num, sdCovmCON):

      instpcMos18Finger = pcMos18FingerGenerator()
      stdmos18 = instpcMos18Finger._MOS18Finger(self.layout,self.cell,well,w, l, sab, gate_contact, gate_contact_num, finger_num, sdCovmCON) 

    def _stdpgringTrans(self, cell, well, subwell, w, l, sab, gate_contact_num, finger_num, subring, typ, grCovmCON):
    ...
    def _stdPmos18(self, w, l, sab, gate_contact, gate_contact_num, finger_num, subring, grCovmCON, sdCovmCON):
      ...
      self._stdpgringTrans(self.cell, self.wellgring, self.wellsubgring, w, l, sab, gate_contact_num, finger_num, subring,"none", grCovmCON)
      self._stdmos18FingerTrans(self.cell, self.wellmos18, w, l, sab, gate_contact, gate_contact_num, finger_num, sdCovmCON)

    def produce_impl(self):

      # call GRing sub fucntion (__pcPmos18)
      stdpmos18 = self._stdPmos18(self.w, self.l, self.sab, self.gate_contact,self.gate_contact_num, self.finger_num, self.subring,self.grCovmCON,self.sdCovmCON)
