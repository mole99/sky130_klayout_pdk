# Taher Kourany, 02.11.22 -- Initial version of nmos18 pcell generator (w,l,sab,gate_contact,gate_contact_num,finger_num,grCovmCON,sdCovmCON)
...
class pcNmos18Generator(pya.PCellDeclarationHelper):
    ...
    """
    Description: 1.8v Nmos Pcell for Skywaters 130nm
    """
    ...
    def __init__(self):
        ...
        self.param("des_param", self.TypeString, "Description", default= "SkyWater 130nm MOS18 Pcell", readonly = True)
    ...
    def _stdn18gring(self, cell, w, l, sab, gate_contact_num, finger_num, grCovmCON):
    ...
    def _stdNmos18(self, w, l, sab, gate_contact, gate_contact_num, finger_num, grCovmCON, sdCovmCON):

      # diff implant input to _stdmos18FingerTrans
      self.wellmos18 = "N+S/D"
      
      self._stdn18gring(self.cell, w, l, sab, gate_contact_num, finger_num, grCovmCON)
    ...
    def produce_impl(self):
      ...
      stdnmos18 = self._stdNmos18(self.w, self.l,self.sab,self.gate_contact,self.gate_contact_num,self.finger_num,self.grCovmCON,self.sdCovmCON)
